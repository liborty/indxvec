...
fn vecops() { 
    ...
    println!("Binary_search for {BL}199{UN}: {GR}{:?}{UN}",sorted.binsearch(&199)); 
    println!("Binsearch_indexed for {BL}{midval}{UN}: {GR}{:?}{UN}", 
        vm.binsearch_indexed(&vi,&midval));  // binsearch_indexed, ascending
    ...
    println!("Binsearch for {BL}199{UN}: {GR}{:?}{UN}",sorteddesc.binsearch(&199)); 
    println!("Binsearchdesc_indexed for {BL}{midval}{UN}: {GR}{:?}{UN}",
        vm.binsearch_indexed(&vi,&midval)); // binsearch_indexed, descending
